...
/**
 * Template Name: Offroad Vehicle Card
 * Description: 4x4/Offroad vehicle card with specs and rental pricing.
 *
			...
			<div class="rb-loop__card-specs">
				...
				<?php if ($doors) : ?>
					<span class="rb-loop__card-spec">
						...
						<?php printf(esc_html(_n('%d door', '%d doors', $doors, 'ridebalkans')), $doors); ?>
					</span>
				<?php endif; ?>
