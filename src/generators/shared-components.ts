 ...
 * 
 * These components are used across multiple blocks for dynamic post selection
 * and field mapping functionality.
 *
 * @package Handoff_Blocks
 * @generated by Handoff WordPress Compiler
 */
...
export { PostQueryBuilder } from './PostQueryBuilder';
`;
};
...
export interface SharedComponentFiles {
  'shared/components/PostSelector.js': string;
  'shared/components/PostQueryBuilder.js': string;
  'shared/components/index.js': string;
  'shared/index.js': string;
}

/**
 * Generate all shared component files
 */
export const generateSharedComponents = (): SharedComponentFiles => {
  return {
    'shared/components/PostSelector.js': generatePostSelector(),
    'shared/components/PostQueryBuilder.js': generatePostQueryBuilder(),
