 ...
 */
export declare const transpileHandlebarsToJsx: (template: string, properties: Record<string, HandoffProperty>, indent?: string, innerBlocksField?: string | null, editorConfig?: HandoffEditorConfig) => TranspileResult;
/**
 ...
 */
export declare const generateJsxPreview: (template: string, properties: Record<string, HandoffProperty>, componentId: string, componentTitle: string, innerBlocksField?: string | null, editorConfig?: HandoffEditorConfig) => JsxPreviewResult;
