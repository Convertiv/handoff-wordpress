...
export declare const isDynamicArrayConfig: (config: FieldConfig) => config is DynamicArrayConfig | BreadcrumbsArrayConfig | TaxonomyArrayConfig | PaginationArrayConfig;
/** Type guard: true when the config is a BreadcrumbsArrayConfig */
export declare const isBreadcrumbsConfig: (config: FieldConfig) => config is BreadcrumbsArrayConfig;
/** Type guard: true when the config is a TaxonomyArrayConfig */
export declare const isTaxonomyConfig: (config: FieldConfig) => config is TaxonomyArrayConfig;
/** Type guard: true when the config is a PaginationArrayConfig */
export declare const isPaginationConfig: (config: FieldConfig) => config is PaginationArrayConfig;
/**
